...
@section('content')
<div class="max-w-xl">
    <p class="text-gray-500 mb-6">Buat kategori baru untuk mengelompokkan barang</p>
        ...
        <form method="POST" action="/categories">
            ...
            <div class="mb-6">
                ...
                <textarea name="description" rows="3"
                    class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">{{ old('description') }}</textarea>
            </div>
